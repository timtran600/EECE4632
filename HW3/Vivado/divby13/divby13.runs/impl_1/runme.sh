...
HD_PWD='C:/FPGAHW/HW3/Vivado/divby13/divby13.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divby13_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divby13_wrapper.tcl -notrace
