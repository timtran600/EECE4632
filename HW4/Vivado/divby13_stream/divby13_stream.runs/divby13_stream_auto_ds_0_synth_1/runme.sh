...
HD_PWD='C:/GitRepos/EECE4632/HW4/Vivado/divby13_stream/divby13_stream.runs/divby13_stream_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divby13_stream_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divby13_stream_auto_ds_0.tcl
