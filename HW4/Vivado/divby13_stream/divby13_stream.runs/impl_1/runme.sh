...
HD_PWD='C:/GitRepos/EECE4632/HW4/Vivado/divby13_stream/divby13_stream.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divby13_stream_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divby13_stream_wrapper.tcl -notrace
