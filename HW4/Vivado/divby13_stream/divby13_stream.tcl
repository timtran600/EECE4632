...
################################################################
# This is a generated script based on design: divby13_stream
#
...
# source divby13_stream_script.tcl
...
set design_name divby13_stream
...
xilinx.com:hls:divby13_stream:1.0\
"
...
\
  ...
  # Create instance: divby13_stream_0, and set properties
  set divby13_stream_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:divby13_stream:1.0 divby13_stream_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins divby13_stream_0/a]
  ...
  connect_bd_intf_net -intf_net divby13_stream_0_result [get_bd_intf_pins divby13_stream_0/result] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins divby13_stream_0/s_axi_control]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs divby13_stream_0/s_axi_control/Reg] -force
