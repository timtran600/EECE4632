...
HLS_SOURCES = ../../../../divby13_stream_tb.cpp ../../../../../../../HW4/Vitis/divby13_stream/divby13_stream.cpp
...
$(ObjDir)/divby13_stream_tb.o: ../../../../divby13_stream_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../divby13_stream_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/divby13_stream_tb.d

$(ObjDir)/divby13_stream.o: ../../../../../../../HW4/Vitis/divby13_stream/divby13_stream.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../../HW4/Vitis/divby13_stream/divby13_stream.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/divby13_stream.d
