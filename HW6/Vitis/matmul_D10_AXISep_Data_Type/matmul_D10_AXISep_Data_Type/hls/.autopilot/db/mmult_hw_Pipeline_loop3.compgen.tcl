...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mmult_hw_mac_muladd_16s_16s_32ns_32_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dim_cast2 \
    op interface \
    ports { dim_cast2 { I 32 vector } } \
} "
}
