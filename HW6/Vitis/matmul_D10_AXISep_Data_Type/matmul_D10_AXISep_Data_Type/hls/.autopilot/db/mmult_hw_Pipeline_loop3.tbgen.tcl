...
set C_modelArgList {
	...
	{ dim_cast2 int 32 regular  }
	{ zext_ln18 int 32 regular  }
	{ in2 int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "CTRL"},"direction": "READONLY"},{"cName": "in2","offset": { "type": "dynamic","port_name": "in2","bundle": "CTRL"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "CTRL"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "dim_cast2", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln18", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ dim_cast2 sc_in sc_lv 32 signal 3 } 
	{ zext_ln18 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dim_cast2", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dim_cast2", "role": "default" }} , 
 	{ "name": "zext_ln18", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "zext_ln18", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	dim_cast2 { ap_none {  { dim_cast2 in_data 0 32 } } }
	zext_ln18 { ap_none {  { zext_ln18 in_data 0 32 } } }
