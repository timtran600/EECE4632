set SynModuleInfo {
  ...
  {SRCNAME mmult_hw_Pipeline_load_a_VITIS_LOOP_25_1 MODELNAME mmult_hw_Pipeline_load_a_VITIS_LOOP_25_1 RTLNAME mmult_hw_mmult_hw_Pipeline_load_a_VITIS_LOOP_25_1
    SUBMODULES {
  ...
  {SRCNAME mmult_hw_Pipeline_load_b_VITIS_LOOP_28_2 MODELNAME mmult_hw_Pipeline_load_b_VITIS_LOOP_28_2 RTLNAME mmult_hw_mmult_hw_Pipeline_load_b_VITIS_LOOP_28_2
    SUBMODULES {
  ...
  {SRCNAME mmult_hw_Pipeline_comp_i_comp_j MODELNAME mmult_hw_Pipeline_comp_i_comp_j RTLNAME mmult_hw_mmult_hw_Pipeline_comp_i_comp_j
    SUBMODULES {
  ...
  {SRCNAME mmult_hw MODELNAME mmult_hw RTLNAME mmult_hw IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME mmult_hw_tC_RAM_AUTO_1R1W RTLNAME mmult_hw_tC_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
