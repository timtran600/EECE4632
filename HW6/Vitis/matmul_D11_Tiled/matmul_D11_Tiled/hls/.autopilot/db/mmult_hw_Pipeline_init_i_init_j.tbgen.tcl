...
dict set ap_memory_interface_dict tC { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ tC int 32 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ tC_address0 sc_out sc_lv 8 signal 0 } 
...
set Spec2ImplPortList { 
	tC { ap_memory {  { tC_address0 mem_address 1 8 }  { tC_ce0 mem_ce 1 1 }  { tC_we0 mem_we 1 1 }  { tC_d0 mem_din 1 32 } } }
}
