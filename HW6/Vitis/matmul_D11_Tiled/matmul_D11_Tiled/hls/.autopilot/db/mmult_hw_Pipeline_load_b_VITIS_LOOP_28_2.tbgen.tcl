set moduleName mmult_hw_Pipeline_load_b_VITIS_LOOP_28_2
set isTopModule 0
...
set C_modelName {mmult_hw_Pipeline_load_b_VITIS_LOOP_28_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "CTRL"},"direction": "READONLY"},{"cName": "in2","offset": { "type": "dynamic","port_name": "in2","bundle": "CTRL"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "CTRL"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "zext_ln23", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ empty_16 sc_in sc_lv 32 signal 17 } 
	{ zext_ln23 sc_in sc_lv 7 signal 18 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln23", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln23", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_5ns_32s_36_1_1_U25", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln23 { ap_none {  { zext_ln23 in_data 0 7 } } }
