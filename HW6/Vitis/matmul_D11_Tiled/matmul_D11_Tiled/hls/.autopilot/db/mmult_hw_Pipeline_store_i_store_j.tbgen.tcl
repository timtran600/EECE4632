...
dict set ap_memory_interface_dict tC { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ tC int 32 regular {array 256 { 1 3 } 1 1 }  }
	{ dim_cast18 int 32 regular  }
	{ empty int 39 regular  }
	{ zext_ln23_1 int 7 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "CTRL"},"direction": "READONLY"},{"cName": "in2","offset": { "type": "dynamic","port_name": "in2","bundle": "CTRL"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "CTRL"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "zext_ln23_1", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tC_address0 sc_out sc_lv 8 signal 1 } 
	{ tC_ce0 sc_out sc_logic 1 signal 1 } 
	{ tC_q0 sc_in sc_lv 32 signal 1 } 
	{ dim_cast18 sc_in sc_lv 32 signal 2 } 
	{ empty sc_in sc_lv 39 signal 3 } 
	{ zext_ln23_1 sc_in sc_lv 7 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tC_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "tC", "role": "address0" }} , 
 	...
 	{ "name": "zext_ln23_1", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln23_1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_5ns_32s_37_1_1_U98", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	tC { ap_memory {  { tC_address0 mem_address 1 8 }  { tC_ce0 mem_ce 1 1 }  { tC_q0 mem_dout 0 32 } } }
	dim_cast18 { ap_none {  { dim_cast18 in_data 0 32 } } }
	empty { ap_none {  { empty in_data 0 39 } } }
	zext_ln23_1 { ap_none {  { zext_ln23_1 in_data 0 7 } } }
