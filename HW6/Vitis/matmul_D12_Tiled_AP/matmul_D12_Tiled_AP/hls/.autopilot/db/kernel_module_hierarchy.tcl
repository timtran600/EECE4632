...
"SubLoops" : [
	...
	{"Name" : "tile_j","ID" : "2","Type" : "no",
		"SubInsts" : [
		{"Name" : "grp_mmult_hw_Pipeline_init_i_init_j_fu_299","ID" : "3","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "init_i_init_j","ID" : "4","Type" : "pipeline"},]},],
		"SubLoops" : [
		{"Name" : "tile_k","ID" : "5","Type" : "no",
			"SubInsts" : [
			{"Name" : "grp_mmult_hw_Pipeline_load_a_VITIS_LOOP_27_1_fu_307","ID" : "6","Type" : "sequential",
					"SubLoops" : [
					{"Name" : "load_a_VITIS_LOOP_27_1","ID" : "7","Type" : "pipeline"},]},
			{"Name" : "grp_mmult_hw_Pipeline_load_b_VITIS_LOOP_30_2_fu_321","ID" : "8","Type" : "sequential",
					"SubLoops" : [
					{"Name" : "load_b_VITIS_LOOP_30_2","ID" : "9","Type" : "pipeline"},]},
			{"Name" : "grp_mmult_hw_Pipeline_store_i_store_j_fu_335","ID" : "10","Type" : "sequential",
					"SubLoops" : [
			...
			{"Name" : "comp_i","ID" : "12","Type" : "no",
				...
				{"Name" : "comp_j","ID" : "13","Type" : "no",
					"SubInsts" : [
					{"Name" : "grp_mmult_hw_Pipeline_comp_k_fu_349","ID" : "14","Type" : "sequential",
							"SubLoops" : [
