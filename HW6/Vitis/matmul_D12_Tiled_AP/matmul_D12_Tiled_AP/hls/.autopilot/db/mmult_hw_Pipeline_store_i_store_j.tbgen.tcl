...
dict set ap_memory_interface_dict tC { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict tC_1 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict tC_2 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict tC_3 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ tC int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ tC_1 int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ tC_2 int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ tC_3 int 32 regular {array 64 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ zext_ln25 sc_in sc_lv 7 signal 7 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_5ns_32s_37_1_1_U44", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_32_1_1_U45", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	tC { ap_memory {  { tC_address0 mem_address 1 6 }  { tC_ce0 mem_ce 1 1 }  { tC_q0 mem_dout 0 32 } } }
	tC_1 { ap_memory {  { tC_1_address0 mem_address 1 6 }  { tC_1_ce0 mem_ce 1 1 }  { tC_1_q0 mem_dout 0 32 } } }
	tC_2 { ap_memory {  { tC_2_address0 mem_address 1 6 }  { tC_2_ce0 mem_ce 1 1 }  { tC_2_q0 mem_dout 0 32 } } }
	tC_3 { ap_memory {  { tC_3_address0 mem_address 1 6 }  { tC_3_ce0 mem_ce 1 1 }  { tC_3_q0 mem_dout 0 32 } } }
