...
set name mmult_hw_mul_62s_32s_62_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add187_0_out \
    op interface \
    ports { add187_0_out { O 32 vector } add187_0_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln23_3_out \
    op interface \
    ports { add_ln23_3_out { O 32 vector } add_ln23_3_out_ap_vld { O 1 bit } } \
} "
}
