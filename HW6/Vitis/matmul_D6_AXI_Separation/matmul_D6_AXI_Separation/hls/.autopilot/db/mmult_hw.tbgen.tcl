...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "CTRL"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "CTRL"},"direction": "READWRITE"}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4", "5", "6", "7"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2572545", "EstimateLatencyMax" : "2572545",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mmult_hw_Pipeline_loop3_fu_190", "Port" : "gmem0", "Inst_start_state" : "13", "Inst_end_state" : "14"}]},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mmult_hw_Pipeline_loop3_fu_190", "Port" : "gmem1", "Inst_start_state" : "13", "Inst_end_state" : "14"}]},
		...
		"Loop" : [
			{"Name" : "loop2", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "20", "FirstState" : "ap_ST_fsm_state3", "LastState" : ["ap_ST_fsm_state20"], "QuitState" : ["ap_ST_fsm_state3"], "PreState" : ["ap_ST_fsm_state2"], "PostState" : ["ap_ST_fsm_state2"], "OneDepthLoop" : "0", "OneStateBlock": ""}},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mmult_hw_Pipeline_loop3_fu_190", "Parent" : "0", "Child" : ["2", "3"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "gmem2_load", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mmult_hw_Pipeline_loop3_fu_190.mul_32s_32s_32_1_1_U1", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mmult_hw_Pipeline_loop3_fu_190.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
...
set ArgLastReadFirstWriteLatency {
	mmult_hw {
		...
		gmem2 {Type IO LastRead 15 FirstWrite 14}
	...
	mmult_hw_Pipeline_loop3 {
		gmem2_load {Type I LastRead 0 FirstWrite -1}
		gmem1 {Type I LastRead 10 FirstWrite -1}
		gmem0 {Type I LastRead 10 FirstWrite -1}
		dim {Type I LastRead 0 FirstWrite -1}
		...
		in2 {Type I LastRead 0 FirstWrite -1}
		add187_out {Type O LastRead -1 FirstWrite 10}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2572545", "Max" : "2572545"}
	, {"Name" : "Interval", "Min" : "2572546", "Max" : "2572546"}
]}
