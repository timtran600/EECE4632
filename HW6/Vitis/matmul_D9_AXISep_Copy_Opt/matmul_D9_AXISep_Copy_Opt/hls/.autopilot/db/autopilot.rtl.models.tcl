set SynModuleInfo {
  {SRCNAME mmult_hw_Pipeline_load_row MODELNAME mmult_hw_Pipeline_load_row RTLNAME mmult_hw_mmult_hw_Pipeline_load_row
    SUBMODULES {
  ...
  {SRCNAME mmult_hw_Pipeline_load_col MODELNAME mmult_hw_Pipeline_load_col RTLNAME mmult_hw_mmult_hw_Pipeline_load_col}
  ...
  {SRCNAME mmult_hw MODELNAME mmult_hw RTLNAME mmult_hw IS_TOP 1
    SUBMODULES {
      {MODELNAME mmult_hw_mul_32ns_32ns_62_1_1 RTLNAME mmult_hw_mul_32ns_32ns_62_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME mmult_hw_rowA_RAM_AUTO_1R1W RTLNAME mmult_hw_rowA_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
