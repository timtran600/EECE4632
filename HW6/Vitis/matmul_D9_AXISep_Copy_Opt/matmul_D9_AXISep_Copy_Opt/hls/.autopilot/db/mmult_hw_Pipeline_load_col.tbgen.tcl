set moduleName mmult_hw_Pipeline_load_col
set isTopModule 0
...
set C_modelName {mmult_hw_Pipeline_load_col}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict colB { MEM_WIDTH 32 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 0}  }
	{ dim int 32 regular  }
	{ empty int 16 regular  }
	{ zext_ln26_1 int 8 regular  }
	{ in2 int 64 regular  }
	{ colB int 32 regular {array 128 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in2","offset": { "type": "dynamic","port_name": "in2","bundle": "CTRL"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "zext_ln26_1", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "in2", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "colB", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln26_1 sc_in sc_lv 8 signal 3 } 
	{ in2 sc_in sc_lv 64 signal 4 } 
	{ colB_address0 sc_out sc_lv 7 signal 5 } 
	{ colB_ce0 sc_out sc_logic 1 signal 5 } 
	{ colB_we0 sc_out sc_logic 1 signal 5 } 
	{ colB_d0 sc_out sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln26_1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "zext_ln26_1", "role": "default" }} , 
 	...
 	{ "name": "colB_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "colB", "role": "we0" }} , 
 	{ "name": "colB_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "colB", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	zext_ln26_1 { ap_none {  { zext_ln26_1 in_data 0 8 } } }
	in2 { ap_none {  { in2 in_data 0 64 } } }
	colB { ap_memory {  { colB_address0 mem_address 1 7 }  { colB_ce0 mem_ce 1 1 }  { colB_we0 mem_we 1 1 }  { colB_d0 mem_din 1 32 } } }
}
