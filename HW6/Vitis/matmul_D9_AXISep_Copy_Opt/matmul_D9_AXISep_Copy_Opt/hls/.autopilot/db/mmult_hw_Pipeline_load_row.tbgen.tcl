set moduleName mmult_hw_Pipeline_load_row
set isTopModule 0
...
set C_modelName {mmult_hw_Pipeline_load_row}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict rowA { MEM_WIDTH 32 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0}  }
	{ dim int 32 regular  }
	{ sext_ln19 int 62 regular  }
	{ rowA int 32 regular {array 128 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "CTRL"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "rowA", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln19 sc_in sc_lv 62 signal 2 } 
	{ rowA_address0 sc_out sc_lv 7 signal 3 } 
	{ rowA_ce0 sc_out sc_logic 1 signal 3 } 
	{ rowA_we0 sc_out sc_logic 1 signal 3 } 
	{ rowA_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rowA_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rowA", "role": "we0" }} , 
 	{ "name": "rowA_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "rowA", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	rowA { ap_memory {  { rowA_address0 mem_address 1 7 }  { rowA_ce0 mem_ce 1 1 }  { rowA_we0 mem_we 1 1 }  { rowA_d0 mem_din 1 32 } } }
}
