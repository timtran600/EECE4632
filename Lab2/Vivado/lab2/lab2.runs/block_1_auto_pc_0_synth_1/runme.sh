...
HD_PWD='C:/Users/tran.timo/lab2/lab2.runs/block_1_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_1_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_1_auto_pc_0.tcl
